...
require (
	github.com/blevesearch/bleve/v2 v2.4.1-0.20240418160603-757705e4c7ca
	github.com/blevesearch/sear v0.2.1
...
require (
	...
	github.com/blevesearch/zapx/v16 v16.0.13-0.20240418135927-eeb2336467b1 // indirect
