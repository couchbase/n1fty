...
require (
	...
	github.com/couchbase/clog v0.0.0-20190523192451-b8e6d5d421bc // indirect
	...
	github.com/couchbase/gocbcore-transactions v0.0.0-20210420181536-74d74532b5ca // indirect
