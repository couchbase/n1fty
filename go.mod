...
require (
	github.com/blevesearch/bleve/v2 v2.4.4-0.20250221064200-0ca3253ea611
...
require (
	...
	github.com/blevesearch/bleve_index_api v1.2.2-0.20250220160913-17c09f7a4a40 // indirect
